...
let story = Story(pages: [
    StoryPage( // 0
        ...
        You enter a local baking competition at the county fair 🎪.

        It’s a beautiful summer day and you are excited! When you enter the room, you look around to see ten identical stations.
    ...
    StoryPage( // 21
        """
        You went for a walk 🚶🏻‍♂️ to feed the ducks 🦆, lost track of time and lost the competition. 🤦🏻‍♂️
